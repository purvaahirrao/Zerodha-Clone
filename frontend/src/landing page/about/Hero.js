    ...
    return (
        <div className='container'>
            <div className='row p-5 mb-5 mt-5'>
             ...
             <div className='row p-5 mb-5 mt-5 border-top text-muted ' style={{lineHeight:"1.8",fomtSize:"1.2em"}}>
                <div style={{width:"48%"}}className='col-6 ml-5 p-5 '>
                <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. <br/>We named the company Zerodha, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p><br/>
